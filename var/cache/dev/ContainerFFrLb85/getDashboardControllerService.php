...
class getDashboardControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.EjdkWEU'] ?? $container->load('get_ServiceLocator_EjdkWEUService'))->withContext('App\\Controller\\Admin\\DashboardController', $container));
