 ...
 */
class getLaborantinRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\LaborantinRepository' shared autowired service.
     *
     * @return \App\Repository\LaborantinRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'LaborantinRepository.php';

        return $container->privates['App\\Repository\\LaborantinRepository'] = new \App\Repository\LaborantinRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
