 ...
 */
class getCreneauRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CreneauRepository' shared autowired service.
     *
     * @return \App\Repository\CreneauRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CreneauRepository.php';

        return $container->privates['App\\Repository\\CreneauRepository'] = new \App\Repository\CreneauRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
