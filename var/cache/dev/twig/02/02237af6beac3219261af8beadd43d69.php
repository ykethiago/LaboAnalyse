...
class __TwigTemplate_9e79645299070dcddea43cb9e66de628 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $this->parent = $this->loadTemplate("base.html.twig", "rendez_vous/index.html.twig", 2);
...
\t\t\t\t\t\t<a class=\"nav-link text-uppercase ";
        ...
        echo "\" style=\"color: white; margin-right:1em; font-size: 1em;\">
\t\t\t\t\t\t\tDashbord
\t\t\t\t\t\t</a>
\t\t\t\t\t</li>
\t\t\t\t</ul>
...
\t</nav>
    ...
    ";
        ...
        ";
        // line 60
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 60, $this->source); })()), "dateRV", [], "any", false, false, false, 60), 'row', ["label_attr" => ["class" => "form-label"]]);
        echo "
        ";
        // line 61
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 61, $this->source); })()), "status", [], "any", false, false, false, 61), 'row', ["label_attr" => ["class" => "form-label"]]);
        echo "
        ";
        // line 62
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 62, $this->source); })()), "motif", [], "any", false, false, false, 62), 'row', ["label_atrr" => ["class" => "form-label"]]);
        echo "
        ";
        // line 63
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 63, $this->source); })()), "patient", [], "any", false, false, false, 63), 'row', ["label_attr" => ["class" => "form-label"]]);
        echo "
...
";
    ...
    {
        return array (  172 => 66,  166 => 63,  162 => 62,  158 => 61,  154 => 60,  150 => 59,  108 => 22,  94 => 11,  88 => 7,  78 => 6,  59 => 4,  36 => 2,);
    }
...
\t</nav>
    ...
    {{ form_start(form, {'attr': {'class': 'form-border'}}) }}
        {{ form_row(form.dateRV, {'label_attr': {'class': 'form-label'}}) }}
        {{ form_row(form.status, {'label_attr': {'class': 'form-label'}}) }}
        {{ form_row(form.motif, {'label_atrr':{'class':'form-label'}}) }}
...
{% endblock %}", "rendez_vous/index.html.twig", "/Users/thiagohenriquedasilva/Downloads/Labo/templates/rendez_vous/index.html.twig");
    }
}
