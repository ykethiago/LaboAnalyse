 ...
 */
class getSecretaireRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\SecretaireRepository' shared autowired service.
     *
     * @return \App\Repository\SecretaireRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SecretaireRepository.php';

        return $container->privates['App\\Repository\\SecretaireRepository'] = new \App\Repository\SecretaireRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
